...
public class AuthControllerYamlTest extends AbstractIntegrationTest {
    ...
    @Test
    public void testYMLMapperSerialization() throws JsonProcessingException {
        AccountCredentialsVO user = new AccountCredentialsVO("leandro", "teste123");
        YMLMapper mapper = new YMLMapper();
        String serialized = (String) mapper.serialize(
                new ObjectMapperSerializationContext() {
                    @Override
    ...
    public void testSignin() throws JsonMappingException, JsonProcessingException {
        ...
        AccountCredentialsVO user =
                new AccountCredentialsVO("leandro", "teste123");
